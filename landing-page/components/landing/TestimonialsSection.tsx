...
export default function TestimonialsSection() {
  return (
    <Section
      id="testimonials"
      name="Avis clients"
      title="Pensé pour les freelances, validé sur le terrain."
      subtitle="Quelques mots de celles et ceux qui ont décidé d’arrêter de bricoler leurs factures dans des fichiers perdus."
    >
